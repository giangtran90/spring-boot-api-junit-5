package com.hgcode.junit5.jsonassert;
...
public class JsonAssertUnitTest {
    ...
    public void whenMessageUsedInAssertion_thenDisplayMessageOnFailure() throws JSONException {
        ...
        try {
            JSONAssert.assertEquals(failureMessage, "{id:123,name:\"John\"}", actual, JSONCompareMode.STRICT);
    ...
    public void whenComparingContentsOfArray_thenPass() throws JSONException {
        ...
        JSONAssert.assertEquals("{ratings:[1,6]}", ratings, new ArraySizeComparator(JSONCompareMode.LENIENT));
    }

    @Test
    public void givenValueMatcher_whenComparingUsingRegex_thenPass() throws IllegalArgumentException, JSONException {
        JSONAssert.assertEquals("{entry:{id:x}}", "{entry:{id:1, id:2, id:3}}", new CustomComparator(JSONCompareMode.STRICT, new Customization("entry.id", new RegularExpressionValueMatcher<Object>("\\d"))));
